                        ...
                        <div className="card flex-shrink-0 w-[400px] max-w-sm shadow-2xl bg-base-100">
                            <div className="card-body">
                                <div className="form-control">
                                    ...
                                    {errors.name && <span className='text-[10px] text-red-500 text-start mt-1'>Name is required</span>}
                                </div>
                                <div className="form-control">
                                    <label className="label">
                                ...
                                <div className="form-control">
                                    ...
                                    <label className="label">
                                        <Link to={'/login'}><a className="label-text-alt link link-hover">Already have account?</a></Link>
                                    </label>
                                </div>
