        ...
        <div><footer className="footer items-center p-4 bg-neutral text-neutral-content">
            ...
            <footer className="footer grid-rows-2 p-10 bg-neutral text-neutral-content ">
                ...
                <div>
                    ...
                    <a className="link link-hover text-white">Github</a>
                </div>
                <div>
                    <span className="footer-title text-white">Explore</span>
                    <a className="link link-hover text-white">Features</a>
                    <a className="link link-hover text-white">Enterprise</a>
                    <a className="link link-hover text-white">Security</a>
                    <a className="link link-hover text-white">Pricing</a>
                </div>
                <div>
                    <span className="footer-title text-white">Apps</span>
                    <a className="link link-hover text-white">Mac</a>
                    <a className="link link-hover text-white">Windows</a>
                    <a className="link link-hover text-white">iPhone</a>
                    <a className="link link-hover text-white">Android</a>
                </div>
            </footer>
        </div>
    );
